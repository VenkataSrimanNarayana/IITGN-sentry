...
import VisitorLogs from "@/components/Logs/VisitorLogs";
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            <CustomTabPanel value={value} index={0}>
                <Logs isDelete={false} logType="self" />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={1}>
                <VehicleLogs isDelete={false} logType="self" />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={2}>
                <VisitorLogs isDelete={false} logType="self" />
            </CustomTabPanel>
        </Box>
    );
}
