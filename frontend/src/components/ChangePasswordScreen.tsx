...
export default function ChangePassword() {
  ...
  const handleChange = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, setter: { (value: SetStateAction<string>): void; (value: SetStateAction<string>): void; (arg0: any): void; }) => {
